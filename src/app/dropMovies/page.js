...
export default function GenreMoviesPage() {
    ...
    return (
        <div className="container mx-auto px-4">
            ...
            <select onChange={handleSelectChange} className="block w-full p-2 border bg-gradient-to-r from-[#000814] from-10% via-[#001d3d] via-30% to-[#000814] to-90% ... text-white rounded-md mb-4">
